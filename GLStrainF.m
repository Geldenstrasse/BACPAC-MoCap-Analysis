...
% 
% 
% OUTPUTS: .mat data file with the sampling frequency, the number of
% samples, the time length, the raw green-lagrange strain matrix, the
% component-wise GL strain matrices, the time-series of the strains in the
% triangle of highest strain, and a boolean to identify NaN entries for the
% trial.
% External .avi file that animates the strain calculations at each moment of the trial
% External .png file showing the strain map at the moment of highest strain
% and the time-series plot of strains in the triangle of highest strain
%
% NOTES: 
%
%
